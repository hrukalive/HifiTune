...
{
public:
    explicit SegmentState(juce::ValueTree tree);

    static SegmentState create(double startBeat, double lengthBeats);
    static bool isSegment(const juce::ValueTree& tree);
